...
| :---         |     :---      |     :--- | :--- | :--- |
| msg   | 字符串     | 否    | "2017-07-01 12:22:12"    | 订单开始时间(按创建时间) |
| code   | 字符串    | 否    | "2017-07-01 12:22:12"    | 订单结束时间(按创建时间) |
| realPay   | 整形     | 否    | 0   |1:已付款;0:已退款|
| receiverName   | 整形    | 否    | 1   | 分页参数，第1页（数据较多时，默认会分页返回）|
| mobile   | 整形     | 否    | 15   | 分页数据，每页显示数据条数 |
--------------------- 
#### 1.5 请求数据
 ``` 
{
